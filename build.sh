...
mkdir build
cd build
cython3 ../GhostRot.py --embed -o GhostRot.c --verbose
if [ $? -eq 0 ]; then
...
gcc -Os -I /usr/include/python3.8 -o GhostRot GhostRot.c -lpython3.8 -lpthread -lm -lutil -ldl
if [ $? -eq 0 ]; then
